...
from sprinkler_server.exceptions import MissingArgument, SprinklerException
...
missing_property_re = re_compile("^(?P<value>'.+?') is a required property$")
additional_property_re = re_compile(
